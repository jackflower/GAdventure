...
func _ready():
	...
	explosion = preload("res://mine_anti_tank/MineExplosion.tscn").instance()
	...
	if(texture_number == 1):
		explosion.get_node("Sprite").texture = preload("res://mine_anti_tank/explosions/green_explode.png")
	if(texture_number == 2):
		explosion.get_node("Sprite").texture = preload("res://mine_anti_tank/explosions/blue_explode.png")
	if(texture_number == 3):
		explosion.get_node("Sprite").texture = preload("res://mine_anti_tank/explosions/red_explode.png")
	pass
